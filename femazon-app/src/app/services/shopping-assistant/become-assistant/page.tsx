  ...
  return (
    <div className="min-h-screen bg-zinc-50 pb-20 pt-8">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <Link href="/services/shopping-assistant" className="mb-8 inline-flex items-center gap-2 text-sm font-medium text-zinc-500 hover:text-zinc-900 transition">
        ...
        {submitted ? (
          <div className="rounded-3xl bg-white p-10 text-center shadow-sm border border-zinc-200">
            ...
            <h1 className="mb-4 text-3xl font-extrabold text-zinc-900">Application Submitted!</h1>
            ...
            <div className="mt-8">
              <Link href="/profile" className="rounded-full bg-zinc-900 px-8 py-3 text-sm font-bold text-white shadow-lg transition hover:bg-rose-500">
                Go to Profile
              </Link>
            </div>
          </div>
          ...
          <div className="rounded-3xl bg-white p-6 shadow-sm border border-zinc-200 sm:p-10">
            <div className="mb-10 text-center">
              ...
              <h1 className="text-3xl font-extrabold text-zinc-900 sm:text-4xl">Become a Shopping Assistant</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-6">
                <h3 className="text-xl font-bold text-zinc-900 border-b border-zinc-100 pb-3">Personal Information</h3>
                ...
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-zinc-900">Profile Photo URL</label>
              ...
              {/* Service Details */}
              <div className="space-y-6">
                <h3 className="text-xl font-bold text-zinc-900 border-b border-zinc-100 pb-3">Service Details</h3>
                <div className="grid gap-6 sm:grid-cols-2">
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-zinc-900">Primary Location / City</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-zinc-900">Languages Spoken</label>
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-zinc-900">Available Days</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-zinc-900">Available Time</label>
                ...
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-zinc-900">Shopping Experience / Why you?</label>
                ...
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-zinc-900">Short Bio (Publicly visible)</label>
              ...
              <div className="rounded-2xl bg-zinc-50 p-6 border border-zinc-100 flex items-center justify-between">
                <div>
                  <h4 className="text-sm font-bold text-zinc-900">Hourly Rate</h4>
